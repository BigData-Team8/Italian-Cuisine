...
params = {
	...
	'kafkaPort': '9092',
	'consumerTopicName': 'ricetteregionali.net_scraping',
	'groupId': 'ricetteregionali_ingredients',
	'numWorkerThreads': 10
}

outputFile = serverInfoFile = os.path.dirname(os.path.realpath(__file__)) + '/ricetteregionali_ingredients'
...
def worker():
	...
	for msg in consumer:
		...
		try:
			...
			kafkaIngredients = record['ingredients']
			i += 1
		except:
			continue

		print(i, ' working on ', record['url'])

		for ingredient in kafkaIngredients:
