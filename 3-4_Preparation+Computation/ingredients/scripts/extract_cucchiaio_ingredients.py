"""
the aim of this program is to extract unique ingredients from a cucchiaio.it_scraping Kafka topic
...
params = {
	...
	'groupId': 'cucchiaio_ingredients',
	'numWorkerThreads': 10
}

outputFile = serverInfoFile = os.path.dirname(os.path.realpath(__file__)) + '/cucchiaio_ingredients'
